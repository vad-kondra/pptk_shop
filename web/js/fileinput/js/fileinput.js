...
(function (factory) {
    ...
    FileInput.prototype = {
            ...
            self.resumableManager = {
                ...
                sendAjax: function (index, retry) {
                    ...
                    if (retry > opts.maxRetries) {
                        rm.setProcessed('modules.admin.views.default.error');
                        return;
                    }
        ...
        _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, formdata, fileId, index, vUrl) {
            ...
            self._mergeAjaxCallback('modules.admin.views.default.error', fnError);
        ...
        _initPreviewActions: function () {
            ...
            $preview.find(btnRemove).each(function () {
                ...
                self._mergeAjaxCallback('modules.admin.views.default.error', fnError, 'delete');
        ...
        _validateImage: function (previewId, fileId, fname, ftype, fsize, iData, exifObj) {
            ...
            $img.one('load', function () {
            ...
            }).one('modules.admin.views.default.error', function () {
                ...
                if (this.complete) {
                    ...
                    if (this.error) {
                        $(this).trigger('modules.admin.views.default.error');
                    }
                }
            });
        },
