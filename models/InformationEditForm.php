...
class InformationEditForm extends CompositeForm
{
    public $title;
    public $short_desc;
    public $body;
    ...
    public function __construct(Information $informationArticles = null, $config = [])
    {
        if ($informationArticles) {
            ...
            $this->_information = $informationArticles;
    ...
    public function rules(): array
    {
        return [
            ...
            [['body'], 'string'],
            [['is_public'], 'boolean'],
            [['title', 'slug'], 'unique', 'targetClass' => Information::class, 'filter' => $this->_information ? ['<>', 'id', $this->_information->id] : null],
        ];
    }
